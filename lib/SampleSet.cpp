...
void cna::SampleSet::read(const std::vector<std::string>& fileNames, const std::string& markersFileName, const std::string& platform, bool isSorted) {
...
void cna::SampleSet::read(const std::string& fileName, const std::string& platform, bool append) {
...
void cna::SampleSet::write(const std::string& fileName) {
