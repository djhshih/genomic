...
BOOST_AUTO_TEST_CASE(NCList_EmptyIndex)
{
	cna::NCList index;
...
BOOST_AUTO_TEST_CASE(NCList_BoundaryTouchAndDuplicates)
{
...
BOOST_AUTO_TEST_CASE(NCList_NestedIntervals)
{
	std::vector<cna::NCList::IntervalRef> intervals;
...
BOOST_AUTO_TEST_CASE(NCList_ZeroLengthInterval)
{
	std::vector<cna::NCList::IntervalRef> intervals;
...
BOOST_AUTO_TEST_CASE(NCList_InvariantsHold)
{
	std::vector<cna::NCList::IntervalRef> intervals;
	intervals.push_back(cna::NCList::IntervalRef{1, 100, 0});
...
BOOST_AUTO_TEST_CASE(NCList_InvariantsHoldWithSameStart)
{
	std::vector<cna::NCList::IntervalRef> intervals;
...
BOOST_AUTO_TEST_CASE(NCList_EmulatesIRangesTraversalOrderAndPruning)
{
	std::vector<cna::NCList::IntervalRef> intervals;
...
BOOST_AUTO_TEST_CASE(NCList_MatchesNaiveClosedIntervalOverlap)
{
	std::vector<cna::NCList::IntervalRef> intervals;
	intervals.push_back(cna::NCList::IntervalRef{1, 100, 0});
	intervals.push_back(cna::NCList::IntervalRef{10, 20, 1});
